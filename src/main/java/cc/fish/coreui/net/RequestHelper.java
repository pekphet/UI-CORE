...
import cc.fish.coreui.thread.Done;
import cc.fish.coreui.thread.ThreadPoolManager;
import cc.fish.coreui.util.Bean2Map;
import cc.fish.coreui.util.ZLog;
...
public class RequestHelper<T extends BaseEntity> {
    ...
    public RequestHelper PostParam(Object object) {
        Map<String, Object> data = Bean2Map.trans(object);
        boolean isFirstParam = false;
        for (String key : data.keySet()) {
            if (!isFirstParam) {
